...
.field public first:Lio/fabric/sdk/android/services/common/QueueFile$Element;

.field public last:Lio/fabric/sdk/android/services/common/QueueFile$Element;
...
.method public constructor <init>(Ljava/io/File;)V
    ...
    .line 2
    iput-object v1, p0, Lio/fabric/sdk/android/services/common/QueueFile;->buffer:[B
    ...
    .line 9
    invoke-static {v0, v10, v11}, Lio/fabric/sdk/android/services/common/QueueFile;->writeInt([BII)V
    ...
    .line 20
    iget-object p1, p0, Lio/fabric/sdk/android/services/common/QueueFile;->buffer:[B

    invoke-static {p1, v3}, Lio/fabric/sdk/android/services/common/QueueFile;->readInt([BI)I

    move-result p1

    iput p1, p0, Lio/fabric/sdk/android/services/common/QueueFile;->fileLength:I
    ...
    invoke-static {p1, v2}, Lio/fabric/sdk/android/services/common/QueueFile;->readInt([BI)I
    ...
    invoke-static {p1, v0}, Lio/fabric/sdk/android/services/common/QueueFile;->readInt([BI)I
    ...
    .line 25
    invoke-virtual {p0, p1}, Lio/fabric/sdk/android/services/common/QueueFile;->readElement(I)Lio/fabric/sdk/android/services/common/QueueFile$Element;
    ...
    .line 26
    invoke-virtual {p0, v0}, Lio/fabric/sdk/android/services/common/QueueFile;->readElement(I)Lio/fabric/sdk/android/services/common/QueueFile$Element;
...
.method public static synthetic access$100(Lio/fabric/sdk/android/services/common/QueueFile;I)I
    ...
    .line 1
    iget p0, p0, Lio/fabric/sdk/android/services/common/QueueFile;->fileLength:I
...
.method public declared-synchronized add([BII)V
    ...
    .line 2
    invoke-virtual {p0, p3}, Lio/fabric/sdk/android/services/common/QueueFile;->expandIfNecessary(I)V
    ...
    invoke-virtual {p0, v2}, Lio/fabric/sdk/android/services/common/QueueFile;->wrapPosition(I)I
    ...
    invoke-virtual {p0, v2, v5, v4, v1}, Lio/fabric/sdk/android/services/common/QueueFile;->ringWrite(I[BII)V
    ...
    invoke-virtual {p0, v2, p1, p2, p3}, Lio/fabric/sdk/android/services/common/QueueFile;->ringWrite(I[BII)V
    ...
    invoke-virtual {p0, p2, p3, p1, v1}, Lio/fabric/sdk/android/services/common/QueueFile;->writeHeader(IIII)V
...
.method public declared-synchronized clear()V
    ...
    .line 1
    :try_start_0
    invoke-virtual {p0, v1, v0, v0, v0}, Lio/fabric/sdk/android/services/common/QueueFile;->writeHeader(IIII)V
...
.method public final expandIfNecessary(I)V
    ...
    invoke-virtual {p0, v0}, Lio/fabric/sdk/android/services/common/QueueFile;->wrapPosition(I)I
    ...
    invoke-virtual {p0, v1, p1, v0, v2}, Lio/fabric/sdk/android/services/common/QueueFile;->writeHeader(IIII)V
    ...
    invoke-virtual {p0, v1, v2, v0, p1}, Lio/fabric/sdk/android/services/common/QueueFile;->writeHeader(IIII)V
...
.method public final readElement(I)Lio/fabric/sdk/android/services/common/QueueFile$Element;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public declared-synchronized remove()V
    ...
    invoke-virtual {p0, v0, v3, v4, v2}, Lio/fabric/sdk/android/services/common/QueueFile;->ringRead(I[BII)V
    ...
    invoke-virtual {p0, v3, v4, v0, v5}, Lio/fabric/sdk/android/services/common/QueueFile;->writeHeader(IIII)V
...
.method public final writeHeader(IIII)V
    ...
    .line 3
    invoke-static {v0, p1, p2}, Lio/fabric/sdk/android/services/common/QueueFile;->writeInt([BII)V
